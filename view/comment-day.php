...
<body>
    <div class="all-wrapper menu-side">
        ...
        -------------------->
            <div class="content-w">
                ...
                <?php include 'partial/comment-chart-container.php' ?>
            </div>
        </div>
    ...
    <script>
        $('#commentChart').remove(); // this is my <canvas> element
        $('#graph-container').append('<canvas height="50px" id="commentChart" width="150px"><canvas>');
