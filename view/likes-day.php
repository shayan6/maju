...
<body>
    <div class="all-wrapper menu-side">
        ...
        -------------------->
            <div class="content-w">
                ...
                <?php include 'partial/like-chart-container.php' ?>
            </div>
        </div>
    ...
    <script>
        $('#likeChart').remove(); // this is my <canvas> element
        $('#graph-container').append('<canvas height="50px" id="likeChart" width="150px"><canvas>');

        $.get(baseURL + "/countChart/like/" + startDate + "/" + endDate + "/" + 365 + "/" + 1, function(data) {
